...
from safetensors.torch import load_file  # 用于 LoRA
...
def load_lora_weights(model, checkpoint_path, alpha=1.0):
    """加载 LoRA 权重并转换为 float16"""
    ...
    for style_dir in BASE_DIR.iterdir():
        ...
        for inner in inner_folders:
            ...
            pipe = StableDiffusionControlNetPipeline.from_pretrained(
                ...
                dtype=torch.float16  # 全部 float16
            )
            pipe.to("cuda")
